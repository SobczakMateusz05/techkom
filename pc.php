        ...
        <div class="right">
            <div class="right-top">
                <h3 class="disable-selection">
                    TechKom > Ten Sklep > Produkty > Komputery
                </h3>
            </div>
            <div class="right-bottom">
                <div class="right-left">
                    ...
                    <div class="buttons-option">
                        <h3 class="disable-selection button" onclick="filtr()">Filtrowanie</h3>
                        ...
                        <form   method="POST" action="pc.php">
                            ...
                            <noscript><input type=”submit” value=”Sortuj” name="submit"></noscript>
                        </form>
                    </div>
                    <div class="filtr disable">
                        <h3> FILTRY</h3>
                        <form method="POST" action="pc.php" class="filtrform">
                            <h4>Procesor: 
                                <select name="proc">
                                    <?php
                                        require_once "connect.php";
                                        $sql="SELECT Distinct procesor FROM produkty ORDER BY procesor ASC";
                            ...
                            <h4>Pamięć RAM: 
                                ...
                                <?php
                                        require_once "connect.php";
                                        $sql="SELECT Distinct ram FROM produkty ORDER BY ram ASC";
                                        if($result=$conn->query($sql)){
                                            while($row=$result->fetch_assoc()){
                    ...
                    <?php
                    $sql = " SELECT * FROM produkty as p JOIN type as t ON p.type = t.id WHERE t.nazwa='komputer'";
                    if($result = $conn->query($sql)){
                        while($row=$result->fetch_assoc()) 
		                {
